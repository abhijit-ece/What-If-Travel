...
import { Compass, Mail, Lock, User, ArrowRight, Loader } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface-dark">
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-12 relative overflow-hidden">
        {/* Glow behind card */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-accent-600/5 rounded-full blur-3xl -z-10 animate-pulse-slow"></div>
        ...
        <div className="w-full max-w-md card bg-surface-card border border-surface-border p-8 rounded-2xl shadow-2xl relative">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-12 h-12 bg-accent-600/10 border border-accent-500/20 rounded-xl flex items-center justify-center mb-4">
              <Compass className="w-6 h-6 text-accent-400" />
            </div>
            <h2 className="text-2xl font-bold text-slate-100">Create Account</h2>
            <p className="text-slate-400 text-sm font-light mt-1">Start simulating your what-if travel scenarios</p>
          </div>
